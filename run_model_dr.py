...
from models.basic_files.dataset_iterator_dr import *
import os
...
class run_model:
    ...
    def add_placeholders(self):
        ...
        self.query_input_placeholder   = tf.placeholder(tf.int32, shape=(None, self.config.max_sequence_length_query),   name = 'query')
        ...
        self.length_query_placeholder = tf.placeholder(tf.int64, shape= (None), name = 'length_query')
    ...
    def fill_feed_dict(self, encoder_inputs, decoder_inputs, labels, query, weights, lengths_query,  feed_previous=False):
	...
	#print (labels)
        ...
        self.length_query_placeholder : lengths_query,
    ...
    def run_epoch(self, epoch_number, sess, fp = None):
        ...
        for step in xrange(steps_per_epoch):
            ...
            train_content, train_title, train_labels, train_query, train_weights,  train_lengths_query = self.dataset.next_batch(
            ...
            feed_dict = self.fill_feed_dict(train_content, train_title, train_labels, train_query, train_weights,  train_lengths_query, feed_previous)
    ...
    def do_eval(self,sess, data_set):
        ...
        for step in xrange(steps_per_epoch):
            ...
            feed_dict  = self.fill_feed_dict(train_content, train_title, train_labels, train_query, train_weights,  train_lengths_query,  feed_previous = True)
    ...
    def run_training(self):
        ...
        with tf.Graph().as_default():
            ...
            self.logits = self.model.inference(self.encode_input_placeholder, self.decode_input_placeholder,
                                          ...
                                          weights = self.weights_placeholder, lengths_query = self.length_query_placeholder, initial_embedding=initial_embeddings,
