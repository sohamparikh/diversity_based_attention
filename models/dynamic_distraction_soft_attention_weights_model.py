...
from basic_files.seq2seq import *
...
class BasicAttention:
    ...
    def inference(self, encoder_inputs1, decoder_inputs1, query_inputs, embedding_size, feed_previous,
        ...
        distract_cell = DistractionLSTMCell_soft(2*hidden_size, state_is_tuple = True)
        ...
        outputs, state     = dynamic_distraction_attention_weights_seq2seq(encoder_inputs = ei,
                                                decoder_inputs = di,
                                                query_inputs = qi,
