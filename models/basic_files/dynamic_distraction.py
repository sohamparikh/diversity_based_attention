...
def dynamic_distraction_decoder(decoder_inputs,
                      initial_state,
...
def dynamic_distraction_seq2seq(encoder_inputs,
                                decoder_inputs,
                                query_inputs,
                                cell_encoder_fw,
                                cell_encoder_bw,
  ...
  """
  with variable_scope.variable_scope(
      scope or "dynamic_distraction_seq2seq", dtype=dtype) as scope:
    dtype = scope.dtype
    # Encoder.
    ...
    def decoder(feed_previous_bool):
      ...
      with variable_scope.variable_scope(
        ...
        outputs, state = dynamic_distraction_decoder_wrapper(
            decoder_inputs,
            initial_state=encoder_state,
