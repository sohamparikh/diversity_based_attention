...
from basic_files.dynamic_vis import *
...
class BasicAttention:
    ...
    def inference(self, encoder_inputs1, decoder_inputs1, query_inputs, embedding_size, feed_previous,
        ...
        outputs, state, query_weights, doc_weights  = dynamic_seq2seq(encoder_inputs = ei,
                                                decoder_inputs = di,
                                                query_inputs = qi,
        ...
        return self.final_outputs, query_weights, doc_weights
